...
export class ReportService {
  ...
  getColumns(reportArea): Observable<string[]>{
      return this.http.get(AppConstants.appUrl+"tableName?reportArea="+reportArea)
  ...
  getReportNames(reportArea): Observable<string[]>{
      return this.http.get(this.appData.appUrl + 'getReport?reportArea='+reportArea)
        .map((response: Response) => response)
        .catch(this.handleError);
    }
